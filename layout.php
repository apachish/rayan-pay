        ...
        <div class="card mb-4 box-shadow">
            ...
            <div class="card-body">
                <h1 class="card-title pricing-card-title">
                    ...
                    if ($response && $response["Status"] == 200){
                        ?>
                        <img src="receipt_success.svg" width="35%" height="35%">
                    <?php }else{ ?>
                ...
                <ul class="list-unstyled mt-3 mb-4">
                    ...
                    if ($response) {
                        ...
                        echo "<li>مبلغ : " . $response["Amount"] . "</li>";
                        if(!empty($response["Mobile"]))
                            echo "<li>تلفن همراه : " . $response["Mobile"] . "</li>";
                        if ($response["Status"] != 200) {
                            echo "<li> کد خطا : " . $response["Status"] . "</li>";
                            echo "<li> تفسیر و علت خطا : " . $response["Message"] . "</li>";
                        }
                        echo "<li> داده ارسالی : ";
                        echo "<ul>";
                        ...
                        echo "</ul></li>";
                        echo "<li> مقدار بازگشتی : ";
                        echo "<ul>";
                        foreach (json_decode($response["Response"],true) as $key => $row) {
                            echo "<li>" . $key . " = " . $row . "</li>";
                        }
                        echo "</ul></li>";
                    }
